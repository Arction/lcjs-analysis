  ...
  function Za(a, b, c) {
    ...
    c.queue ||
      ...
      1 === a.nodeType &&
        ...
        (j = n.css(a, "display")),
        "inline" ===
          ("none" === j ? N.get(a, "olddisplay") || za(a.nodeName) : j) &&
          "none" === n.css(a, "float") &&
        ...
        return g !== n && 9 === g.nodeType && g.documentElement
          ? ((n = g),
            ...
            (d.find.CLASS =
              c.getElementsByClassName &&
              function(a, b) {
                return void 0 !== b.getElementsByClassName && p
              ...
              function(b) {
                ...
                if (f && void 0 === b) {
                  if (
                    ...
                    return c;
                  if (((d = n.camelCase(a)), void 0 !== (c = O.get(f, d))))
                    return c;
          ...
          c.handler && ((f = c), (c = f.handler), (e = f.selector)),
            ...
            (g = r.handle) ||
              (g = r.handle = function(b) {
                return void 0 !== n && n.event.triggered !== b.type
    ...
    toggleClass: function(a, b) {
      ...
      return "boolean" == typeof b && "string" === c
        ...
        : this.each(function() {
            var b, d, e, f;
            if ("string" === c)
              for (d = 0, e = n(this), f = a.match(G) || []; (b = f[d++]); )
              ...
              (void 0 !== a && "boolean" !== c) ||
                ...
                this.setAttribute &&
                  this.setAttribute(
                    "class",
                    b || !1 === a ? "" : N.get(this, "__className__") || ""
                  ));
          });
    },
    hasClass: function(a) {
  ...
  (vb.href = jb.href),
    n.extend({
      ...
      ajax: function(b, c) {
          ...
          2 !== v &&
            ...
            j
              ? (m.ifModified &&
                  ...
                  (w = x.getResponseHeader("etag")) && (n.etag[f] = w)),
                204 === b || "HEAD" === m.type
                  ? (y = "nocontent")
                  : 304 === b
                  ? (y = "notmodified")
        ...
        if (m.beforeSend && (!1 === m.beforeSend.call(o, x, m) || 2 === v))
          return x.abort();
        w = "abort";
